...
extension BSON.AnyValue: Decoder {
    ...
    @inlinable public func singleValueContainer() -> any SingleValueDecodingContainer {
        BSON.SingleValueDecoder.init(self, path: []) as any SingleValueDecodingContainer
    }
    @inlinable public func unkeyedContainer() throws -> any UnkeyedDecodingContainer {
        try BSON.SingleValueDecoder.init(self, path: []).unkeyedContainer()
    }
    @inlinable public func container<Key>(
        keyedBy _: Key.Type
