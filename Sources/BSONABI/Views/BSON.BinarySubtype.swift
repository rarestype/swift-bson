extension BSON {
    ...
    @frozen public struct BinarySubtype: Hashable, RawRepresentable, Sendable {
        ...
        @inlinable public init(unchecked code: UInt8) {
            self.rawValue = code
        }
        ...
        @inlinable public static func custom(code: UInt8) -> Self {
            if code < 0x80 {
