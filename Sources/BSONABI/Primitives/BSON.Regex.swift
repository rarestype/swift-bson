extension BSON {
    /// A MongoDB regex.
    @frozen public struct Regex: Equatable, Sendable {
        public var pattern: String
        public var options: Options

        @inlinable public init(pattern: String, options: Options) {
...
extension BSON.Regex {
    @inlinable public init(pattern: String, options: some StringProtocol) throws {
