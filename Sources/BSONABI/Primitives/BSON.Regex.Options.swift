extension BSON.Regex {
    ...
    @frozen public enum Option: UInt8, CaseIterable, Hashable, Sendable {
    ...
    @frozen public struct Options: OptionSet, Sendable {
...
extension BSON.Regex.Option {
    ...
    @inlinable public var scalar: Unicode.Scalar {
        switch self {
        case .i: "i"
        case .l: "l"
        case .m: "m"
...
extension BSON.Regex.Options {
    ...
    @inlinable public init(parsing string: some StringProtocol) throws {
...
extension BSON.Regex.Options: CustomStringConvertible {
    @inlinable public func contains(option: BSON.Regex.Option) -> Bool {
        self.rawValue & option.rawValue != 0
    }
    /// This option set, encoded in alphabetical order as a option string.
    @inlinable public var description: String {
        .init(
            BSON.Regex.Option.allCases.lazy.compactMap {
