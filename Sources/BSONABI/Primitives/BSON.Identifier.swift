extension BSON {
    ...
    @frozen public struct Identifier: Sendable {
        public let bitPattern: (UInt32, UInt32, UInt32)
        ...
        @inlinable init(bitPattern: (UInt32, UInt32, UInt32)) {
...
extension BSON.Identifier {
    ...
    /// big-endian.
    @inlinable public init(_ high: UInt32, _ middle: UInt32, _ low: UInt32) {
    ...
    @inlinable public init(
        with initialize: (_ memory: UnsafeMutableRawBufferPointer) throws -> ()
    ) rethrows {
...
extension BSON.Identifier {
    ...
    @inlinable public var timestamp: UInt32 {
    ...
    @inlinable public var middle: UInt32 {
    ...
    @inlinable public var low: UInt32 {
...
extension BSON.Identifier: ExpressibleByIntegerLiteral {
    @inlinable public init(integerLiteral: StaticBigInt) {
        precondition(
            integerLiteral.signum() >= 0,
            "BSON identifier literal cannot be negative"
        )
        precondition(
            integerLiteral.bitWidth <= 97, // +1 bit for “sign” bit
...
extension BSON.Identifier {
    ...
    public typealias Ordinal = (
        UInt8,
        UInt8,
        UInt8
    )

    @inlinable public init(timestamp: UInt32, seed: Seed, ordinal: Ordinal) {
        self.init(
            bitPattern: (
                timestamp.bigEndian,
    ...
    @inlinable public var seed: Seed {
    ...
    @inlinable public var ordinal: Ordinal {
        withUnsafeBytes(of: self.bitPattern) {
