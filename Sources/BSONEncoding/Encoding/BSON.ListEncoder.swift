...
extension BSON {
    ...
    @frozen public struct ListEncoder {
...
extension BSON.ListEncoder {
    @inlinable public subscript(_: (BSON.EndIndex) -> Void) -> BSON.FieldEncoder {
        _read {
...
extension BSON.ListEncoder {
    ...
    @inlinable public mutating func callAsFunction(_ yield: (inout BSON.ListEncoder) -> ()) {
