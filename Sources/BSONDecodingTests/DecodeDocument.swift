...
extension DecodeDocument {
    @Test static func KeyNotUnique() throws {
...
extension DecodeDocument {
    @Test func KeyNotPresent() throws {
    ...
    @Test func KeyNotMatchingInhabited() throws {
        #expect(
            throws: BSON.DecodingError<CodingKey>.init(
