...
@Suite struct ValidBSON {
    ...
    @Test static func undefined() throws {
        try Self.test(
    ...
    @Test static func timestamp() throws {
        try Self.test(
    ...
    @Test static func decimal128() throws {
        try Self.test(
    ...
    @Test static func symbol() throws {
        try Self.test(
