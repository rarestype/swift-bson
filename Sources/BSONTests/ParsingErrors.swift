...
@Suite struct InvalidBSON {
    ...
    @Test static func uint64() throws {
        try Self.test(
            "truncated",
    ...
    @Test static func millisecond() throws {
        try Self.test(
            "truncated",
    ...
    @Test static func double() throws {
        // note: frameshift
        try Self.test(
            "truncated",
    ...
    @Test static func pointer() throws {
        try Self.test(
    ...
    @Test static func binary() throws {
        try Self.test(
            "invalid-length-over",
    ...
    @Test static func javascript() throws {
        try Self.test(
            "missing-trailing-null-byte",
    ...
    @Test static func javascriptScope() throws {
        ...
        // frameshift error.
        try Self.test(
            "invalid-length-frameshift-clips-scope",
            invalid: """
...
extension InvalidBSON {
    private static func test(
        _ name: String,
        invalid: String,
        catching error: some Error & Equatable
    ) throws {
